...
// 2 weeks
export const DELAY_WHILE_AD_BLOCKER_OR_TO_SECOND_SURVEY = process.env?.DELAY_WHILE_AD_BLOCKER_OR_TO_SECOND_SURVEY;
// 2 days
...
// 5 minutes
export const AD_PERSONALIZATION_RETRY_INTERVAL = process.env?.AD_PERSONALIZATION_RETRY_INTERVAL;
// 3 attempts
export const MAX_AD_PERSONALIZATION_RETRY_ATTEMPTS = process.env?.MAX_AD_PERSONALIZATION_RETRY_ATTEMPTS;
// 10 minutes
export const AD_PERSONALIZATION_FIRST_AUTO_CHECK_DELAY = process.env?.AD_PERSONALIZATION_FIRST_AUTO_CHECK_DELAY;